                ...
                <form class="p-4" method="post" action="{{ route('admin.audits.standards.store') }}" enctype="multipart/form-data">
                    ...
                    <div class="form-row">
                        ...
                        <div class="col mb-4">
                            ...
                            <input type="text" class="form-control @error('name') is-invalid @enderror" id="name" name="name" value="{{ old('name') }}" placeholder="Nama Standar">
                            @error('name')
                                <div class="invalid-feedback">
                                    {{ $message }}
                                </div>
                        ...
                        <div class="col mb-4">
                            ...
                            <input type="text" class="form-control @error('brief_content') is-invalid @enderror" id="brief_content" name="brief_content" value="{{ old('brief_content') }}" placeholder="Text singkat mewakili Isi standar">
                            @error('brief_content')
                                <div class="invalid-feedback">
                                    {{ $message }}
                                </div>
                        ...
                        <div class="col mb-4">
                            ...
                            <div class="editor-container editor-container_inline-editor" id="editor-container">
                                <div class="editor-container__editor">
                                    <textarea name="content" class="form-control @error('content') is-invalid @enderror" rows="10" cols="30" id="editor"></textarea>
                                </div>
                            </div>
                            @error('content')
                                <div class="invalid-feedback">
