        ...
        <div class="col-sm-12">
            <div class="card">
                <div class="card-header pb-0">
                    <form action="{{ route('admin.users.unit-jurusan.index') }}">
                        <div class="row mb-2">
                            <div class="col-2">
                            ...
                            <tbody>
                                @foreach ($users as $value)
                                    <tr>
                                        ...
                                        <td>
                                            <ul class="action">
                                                <li class="detail me-3"><a href="{{ route('admin.users.unit-jurusan.show', $value->id) }}"><i class="icon-eye"></i></a></li>

                                                <li class="edit me-2"><a href="{{ route('admin.users.unit-jurusan.edit', $value->id) }}"><i class="icon-pencil-alt"></i></a></li>

                                                <li class="delete">
                                                    <form action="{{ route('admin.users.unit-jurusan.destroy', $value->id) }}" method="post">
                                                        @method('delete')
                                                        @csrf
                                        ...
                                        <td>{{ $value->jurusan->name_jurusan }}</td>
                                        <td>{{ $value->name }}</td>
                                        <td>{{ $value->nidn }}</td>
