...
@section('content')
    <ol class="breadcrumb p-l-0">
        <li class="breadcrumb-item active"><a href="{{ route('unit.audits.audit_standards.index', $standard->id) }}">Standar Audit</a></li>
            ...
            <div class="card">
                <div class="row">
                    ...
                    <div class="col-md-6 p-0">
                        <a href="{{ route('unit.audits.audit_standards.index', $audit->id) }}" class="btn btn-danger btn-sm ms-2">Back</a>
                    </div>
                </div>
            </div>
        </div>
