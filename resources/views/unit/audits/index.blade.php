                                ...
                                @foreach ($audits as $value)
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            <a href="#" class="btn btn-sm btn-pill @if ($value->is_done) btn-primary btn-air-primary @else btn-danger btn-air-danger @endif" role="button">
                                                @if ($value->is_done)
                                                    Selesai
                                                @else
                                                    Proses
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                <div style="display: grid; grid-template-columns: 1fr 2fr; grid-row-gap: 10px; align-items: center;">
                                                    <span>Mekanisme</span>
                                                    <div><a href="{{ route('unit.audits.mechanisms.index', $value->id) }}" class="btn btn-sm btn-pill @if ($value->is_mechanism) btn-primary btn-air-primary @else btn-danger btn-air-danger @endif" role="button">
                                                    ...
                                                    <span>Audit</span>
                                                    <div><a href="{{ route('unit.audits.audit_standards.index', $value->id) }}" class="btn btn-sm @if ($value->is_audit) btn-primary btn-air-primary @else btn-danger btn-air-danger @endif" role="button">
                                                            @if ($value->is_audit)
                                                                Sudah Diisi
                                                            @else
                                                                Belum Diisi
                                                    ...
                                                    <div><a href="{{ route('unit.audits.conclusions.index', $value->id) }}" class="btn btn-sm @if ($value->is_conclusion) btn-primary btn-air-primary @else btn-danger btn-air-danger @endif" role="button">
                                            ...
                                            <td>
                                                ...
                                                @else
                                                    <ul class="action">
                                                        <li class="delete">
                                                            <form action="{{ route('unit.audits.lock', $value->id) }}" method="post">
                                                                @method('put')
                                                                @csrf
                                                                <button title="Kunci Audit" class="border-0" style="background-color: transparent;" onClick="return confirm('Are You Sure')"><i class="icon-lock"></i></button>
                                                            </form>
                                                        </li>
                                                    </ul>
                                                @endif
